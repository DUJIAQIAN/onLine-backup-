		...
		<div class="btn-group btn-group-justified">
    		...
    		Vos Compte  <span class="caret"></span></button>
    			<ul class="dropdown-menu" role="menu" style="min-width:100%">
    				...
    				<li><a href="CreerCptTitre.jsp"><span class="glyphicon glyphicon-chevron-right"></span>
...
<div class="container">	
	   <div class="step">			
			<span>	
			 ...
			 <form class="form-inline" action="ServletCptTitre" method="POST" >
  			<div class="form-group stepContent">
   			 	 <label for="numeroCpt">Numéro de compte courant (Ex. : 8888)</label>
   				 <input type="text" class="form-control" id="numeroCpt" name="numeroCpt" required />
  			</div>		
			<span>	
  			 ...
  			 <div class="form-group stepContent">
    			...
    			<input type="password" style="width:180px;" class="form-control" id="pwd" name="pwd" required />
 			</div>
 			<br>
 			<div class="form-group stepContent">	
