...
<div class="container">
  <div class="panel-group">
		...
		for (Cookie c : cookies){
		 if (c.getName().equals("RESULT")){
			 %> <div class="alert alert-info alert-dismissible fade in">
				<a href="/ProjetS8/LoginForm.jsp" class="close" data-dismiss="alert" aria-label="close">&times;</a>
	...
	<% 	if ((String)request.getSession().getAttribute("user")==null){ } else{%>
		<div class="alert alert-danger alert-dismissible fade in">
    	<a href="/ProjetS8/LoginForm.jsp" class="close" data-dismiss="alert" aria-label="close">&times;</a>
			<span><%=(String)request.getSession().getAttribute("user")%></span>
		</div>
